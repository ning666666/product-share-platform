package com.share.wx.api.controller;
...
import com.share.platform.api.dto.request.UserBindPhoneNumRequest;
import com.share.platform.api.dto.request.UserLoginInfoRequest;
import com.share.platform.api.dto.request.UserRegisterInfoRequest;
import com.share.platform.api.dto.request.UserResetInfoRequest;
...
import com.share.wx.api.annotation.LoginUser;
import com.share.wx.api.dao.UserInfo;
import com.share.wx.api.dao.UserToken;
import com.share.wx.api.dao.WxLoginInfo;
import com.share.wx.api.service.UserTokenManager;
import com.share.wx.api.util.IpUtil;
...
public class WxAuthController {
	...
	public Object login(@RequestBody UserLoginInfoRequest userLoginInfoRequest, HttpServletRequest request) {
		...
		String username = JacksonUtil.parseString(userLoginInfoRequest.getUsername(), "username");
		String password = JacksonUtil.parseString(userLoginInfoRequest.getPassword(), "password");
